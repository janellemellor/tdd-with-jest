...
describe('validator module', () => {
  ...
  //tests that castTo functions are working correctly (returns correct value type from valid inputs and throws errors for invalid inputs)
  describe('casters', () => {
    //tests that castToNumber receives a valid value and casts or turns it into a number
    ...
    //tests that castToNumber receives an invalid value that cannot turn into a number so throws an error
    it('throws if value is not castable to number', () => {
      expect(() => castToNumber('hi')).toThrowErrorMatchingSnapshot();
      expect(() => castToNumber({})).toThrowErrorMatchingSnapshot();
    });

    //tests that castToString receives a valid value and casts or turns it into a string
    ...
    //tests that castToString receives an invalid value that cannot turn into a string so throws an error
    it('throws if value is not castable to string', () => {
      expect(() => castToString({})).toThrowErrorMatchingSnapshot();
      expect(() => castToString(() => {})).toThrowErrorMatchingSnapshot();
    });

    //tests that castToBoolean receives a valid value and casts or turns it into true/false
    ...
    //tests that castToBoolean receives an invalid value that cannot turn into a boolean so throws an error
    it('throws if value is not castable to boolean', () => {
      expect(() => castToBoolean({})).toThrowErrorMatchingSnapshot();
      expect(() => castToBoolean(() => {})).toThrowErrorMatchingSnapshot();
    });

    //tests that castToArray receives a valid value and casts or turns it into an array
    it('can cast values to an array', () => {
      expect(castToArray(castToString)(['hi', 'there', 3])).toEqual(['hi', 'there', '3']);
    });

    //tests that castToArray receives an invalid value that cannot turn into an array so throws an error
