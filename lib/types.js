...
//castToArray takes caster as an parameter, and returns a function that takes val as a parameter (curried function)
const castToArray = caster => val => {
  try {
    //maps over the value and turns it into the casted type
...
const getCaster = Type => {
  //if it's an array(with a type) return the array as the casted type
